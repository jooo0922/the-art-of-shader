...
import fs from "./glsl/blueStars.fs";

// 구체 인스턴스 개수 관련 상수들
const NUM_STAR_INSTANCE = 3; // 별 인스턴스 개수
const NUM_DUST_INSTANCE = 35; // 먼지 인스턴스 개수
const NUM_ALL_INSTANCE = NUM_STAR_INSTANCE + NUM_DUST_INSTANCE; // 전체 인스턴스 개수

// 구체 인스턴스 반경 관련 상수들
const MAX_STAR_RADIUS = 1000; // 원점에서 각 별까지의 최대 반경
const MIN_STAR_RADIUS = 600; // 원점에서 각 별까지의 최소 반경
const MAX_DUST_RADIUS = 250; // 원점에서 각 먼지까지의 최대 반경
const MIN_DUST_RADIUS = 10; // 원점에서 각 먼지까지의 최소 반경

// 구체 인스턴스 높이 관련 상수들
const MAX_STAR_HEIGHT = 500; // 원점에서 각 별까지의 최대 높이
const MIN_STAR_HEIGHT = 60; // 원점에서 각 별까지의 최소 높이
const MAX_DUST_HEIGHT = 5; // 원점에서 각 먼지까지의 최대 높이
const MIN_DUST_HEIGHT = -20; // 원점에서 각 먼지까지의 최소 높이

// 구체 인스턴스 크기 관련 상수들
const MAX_STAR_SCALE = 100; // 각 별의 최대 크기
const MIN_STAR_SCALE = 10; // 각 별의 최소 크기
const MAX_DUST_SCALE = 0.8; // 각 먼지의 최대 크기
 ...
 */
export default class BlueStars extends THREE.InstancedMesh {
  constructor() {
    ...
    super(geometry, material, NUM_ALL_INSTANCE);
    this.name = "BlueStar";
