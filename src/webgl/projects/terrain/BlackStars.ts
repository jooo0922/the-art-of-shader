...
import fs from "./glsl/blackStars.fs";

// 구체 인스턴스 개수 관련 상수들
const NUM_STAR_INSTANCE = 4; // 별 인스턴스 개수
const NUM_DUST_INSTANCE = 25; // 먼지 인스턴스 개수
...
// 구체 인스턴스 높이 관련 상수들
const MAX_STAR_HEIGHT = 800; // 원점에서 각 별까지의 최대 높이
const MIN_STAR_HEIGHT = 200; // 원점에서 각 별까지의 최소 높이
const MAX_DUST_HEIGHT = 10; // 원점에서 각 먼지까지의 최대 높이
const MIN_DUST_HEIGHT = -25; // 원점에서 각 먼지까지의 최소 높이

// 구체 인스턴스 크기 관련 상수들
const MAX_STAR_SCALE = 200; // 각 별의 최대 크기
const MIN_STAR_SCALE = 7; // 각 별의 최소 크기
const MAX_DUST_SCALE = 2; // 각 먼지의 최대 크기
 ...
 */
export default class BlackStars extends THREE.InstancedMesh {
  constructor() {
